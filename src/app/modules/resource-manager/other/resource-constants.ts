...
/* Books */
export const ADD_BOOK_MENU_TITLE = 'Add Book'
export const EDIT_BOOK_MENU_TITLE = 'Edit Book'
export const REMOVE_BOOK_MENU_TITLE = 'Remove Book(s)'
...
/* Games */
export const ADD_GAME_MENU_TITLE = 'Add Game'
export const EDIT_GAME_MENU_TITLE = 'Edit Game'
export const REMOVE_GAME_MENU_TITLE = 'Remove Game(s)'
