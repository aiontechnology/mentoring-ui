...
export const MENTOR_DETAIL_DELETE_DIALOG_MANAGER = new InjectionToken<DialogManager<ConfirmationDialogComponent>>('mentor-detail-delete-dialog-manager')
...
export const MENTOR_LIST_DELETE_DIALOG_MANAGER = new InjectionToken<DialogManager<ConfirmationDialogComponent>>('mentor-list-delete-dialog-manager')
