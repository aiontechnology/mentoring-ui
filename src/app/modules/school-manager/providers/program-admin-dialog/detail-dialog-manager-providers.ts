...
export function detailDialogManagerProviders<MODEL_TYPE, COMPONENT_TYPE>(
  ...
  return [
    ...detailAfterClosedDeleteProviders<MODEL_TYPE>(DETAIL_AFTER_CLOSED_DELETE, routeAfterDelete, singleItemCacheUpdaterToken),
    ...
    ...detailDialogManagerEditProviders<COMPONENT_TYPE>(editName, componentType, DETAIL_AFTER_CLOSED_EDIT),
  ]
}
